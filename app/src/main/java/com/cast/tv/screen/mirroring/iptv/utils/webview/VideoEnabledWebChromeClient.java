package com.cast.tv.screen.mirroring.iptv.utils.webview;
...
public class VideoEnabledWebChromeClient extends WebChromeClient implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener
{
     ...
     */
    @SuppressWarnings("unused")
    public VideoEnabledWebChromeClient(ViewGroup activityVideoView)
    {
     ...
     */
    @SuppressWarnings("unused")
    public VideoEnabledWebChromeClient(ViewGroup activityVideoView, VideoEnabledWebView webView)
    {
        this.activityVideoView = activityVideoView;
